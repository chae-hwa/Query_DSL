...
class UserRepositoryTests {
    ...
    @Test
    @DisplayName("no sql, 축구에 관심있는 회원들 검색")
    void t12(){
    ...
    @Test
    @DisplayName("u2=아이돌, u1=팬 u1은 u2의 팔로워다.")
    @Rollback(false)
    void t13(){
        SiteUser u1 = userRepository.getQslUser(1L);
        SiteUser u2 = userRepository.getQslUser(2L);
    ...
    @Test
    @DisplayName("본인은 본인을 follow 할 수 없다.")
    @Rollback(false)
    void t14(){
        SiteUser u1 = userRepository.getQslUser(1L);
    ...
    @Test
    @DisplayName("u2는 followers와 followings를 알 수 있어야 한다.")
    void t15() {
        SiteUser u1 = userRepository.getQslUser(1L);
        SiteUser u2 = userRepository.getQslUser(2L);
    ...
    @Test
    @DisplayName("u2은 더이상 농구에 관심이 없습니다.")
    void t16() {
        SiteUser u1 = userRepository.getQslUser(1L);
